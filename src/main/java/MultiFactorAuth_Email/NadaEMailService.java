...
public class NadaEMailService {
    ...
    public List<InboxEmail> getInbox() throws JSONException, UnirestException, JsonParseException, JsonMappingException, IOException{
    ...
    public EmailMessage getMessageWithSubjectStartsWith(final String emailSubject) throws JsonParseException, JsonMappingException, IllegalArgumentException, JSONException, UnirestException, IOException{
